...
vim.api.nvim_set_keymap("n", "<Space>", "<NOP>", show) -- is this causing issues?
vim.g.mapleader = " "
...
-- Custom
--[[ keymap( "n", "gD", "<cmd>lua require('typescript').goToSourceDefinition(winnr, opts)", noshow) ]]
